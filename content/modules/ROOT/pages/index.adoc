...
= Discovering Critical Security Features in Red Hat Enterprise Linux
...
== Lab2: How to generate tailored SELinux policies for containers
include::lab2_SELinux_part2_udica.adoc[]
...
== Lab4: Auditing on Red Hat Enterprise Linux 9
include::lab6_Audit.adoc[]

== Lab5: Advanced Intrusion Detection Environment (AIDE)
